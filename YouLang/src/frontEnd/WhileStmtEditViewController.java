...
public class WhileStmtEditViewController {

	@FXML private TextField whileField;
	@FXML private TextField doField;
	...
	public WhileStmtEditViewController() {
		
	}
	
	@FXML private void initialize(){
		whileField.textProperty().addListener(
		...
		doField.textProperty().addListener(
				new ChangeListener<String>() {
					public void changed (ObservableValue<? extends String> observable, String oldValue, String newValue) {
						try {
							if (!newValue.equals("")) {
